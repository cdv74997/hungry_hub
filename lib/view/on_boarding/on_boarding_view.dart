...
class _OnBoardingViewState extends State<OnBoardingView> {
  ...
  List pageArr = [
    {
      "title":"Find Food You Enjoy",
      "subtitle":"Discover the best food from hundreds\nof restaurants and fast delivery",
      "image":"assets/img/on_boarding_1.png",
    },
    {
      "title":"Fast Delivery",
      "subtitle":"Fast delivery to your home, school, office\nor wherever you are",
            ...
            Row(
              ...
              children: pageArr.map((e) {
                ...
                return Container(
                  ...
                  height: 6,
                  width: 6,
                  decoration: BoxDecoration(color: index == selectPage ? TColor.primary : TColor.placeholder,
