      ...
      body: Stack(
        ...
        children: [
          ...
          Container(
            height: media.width,
            width: media.width,
            decoration: const BoxDecoration(gradient: LinearGradient(colors: [Colors.black, Colors.transparent, Colors.black ], begin: Alignment.topCenter, end: Alignment.bottomCenter, ), )),
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Padding(
                                padding: const EdgeInsets.symmetric(horizontal: 25),
                                child: Text(
                                      "Lorem ipsum sit amet, consecutor adipiscing elit. Ornare leo non mollis id cursus. Eu euismod faucibus in leo malesuada", 
                                      style: TextStyle(
                              ...
                              Padding(
                                ...
                                child: DropdownButtonHideUnderline(
                                  child: DropdownButton(
                                    isExpanded: true,
                                    items: ["Pepperoni", "Bacon", "Chicken", "Mushrooms", "Bell Poppers", "Onions", "Olives", "Sausage"].map((e) {
                                      return DropdownMenuItem(
                                        value: e,
                                        child: Text(
                                          e,
                                  ...
                                  children: [
                                    ...
                                    Center(
                                      child: Stack(
                                          ...
                                          children: [
                                            Container(
                                              margin: const EdgeInsets.only(top: 8, bottom: 8, left: 10, right: 20),
                                            ...
                                            InkWell(
                                              ...
                                              child: Container(
                                                    ...
                                                    alignment: Alignment.center,
                                                    child: Image.asset("assets/img/shopping_cart.png", width: 20, height: 20, color: TColor.primary,),
