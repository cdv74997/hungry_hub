...
import 'package:hungry_hub_2/view/login/new_password_view.dart';
import 'package:otp_pin_field/otp_pin_field.dart';


class OneTimePasswordView extends StatefulWidget {
  const OneTimePasswordView({super.key});

  @override 
  State<OneTimePasswordView> createState() => _OneTimePasswordViewState();
}

class _OneTimePasswordViewState extends State<OneTimePasswordView> {
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                "We have sent your one time password to your mobile", 
              ...
              Text(
                "Please check your mobile number ******1223\nto continue to reset your password", 
                style: TextStyle(
